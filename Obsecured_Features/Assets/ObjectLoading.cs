...
namespace OpenTKEngine.Obsecured_Features.Assets
{
    static class ObjectLoading
    {
        public static ModelData ReadModel(string FileName)
        {
            ...
            Assimp.Scene Model = Context.ImportFile(FullPath,
            ...
            foreach (Mesh mesh in Meshes)
            {
                ...
                {
                    data.UVs = [.. mesh.TextureCoordinateChannels[0].SelectMany(Coord => new float[] { Coord.X, Coord.Y })];
                }
