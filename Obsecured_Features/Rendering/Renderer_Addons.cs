...
namespace OpenTKEngine.Obsecured_Features.Rendering
{
    public class FrameBuffer
    {
        ...
        public static Shader FrameBufferShader = null!;
        ...
        public FrameBuffer()
        {
            ...
            // XYZ
            GL.VertexArrayAttribFormat(FrameBufferVAO, 0, 3, VertexAttribType.Float, normalized: false, 0);
            GL.VertexArrayAttribBinding(FrameBufferVAO, 0, 0);

            // UV
            GL.VertexArrayAttribFormat(FrameBufferVAO, 1, 2, VertexAttribType.Float, normalized: false, sizeof(float) * 3);
    ...
    public class ShadowMapper
    {
        ...
        public void PreRender(Vector3 LightPos)
        {
            ...
            GL.UniformMatrix4(GL.GetUniformLocation(ShadowMappingShader.Handle, "U_LightSpaceMatrix"), transpose: false, ref LightSpaceMatrix);
