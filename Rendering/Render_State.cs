...
public static class GlobalRenderVars
{
    // VAO Data
    public static int VAOHandle;

    // VBO Data
    public static int VBOHandle;
    private static List<float> VBOData = [];
    public static float[] VBODataCache = [];
    private static bool VBOCacheDirty = false;

    // EBO Data
    public static int EBOHandle;
    private static List<int> EBOData = [];
    public static int[] EBODataCache = [];
    ...
    public static DrawCommand[] DrawCommandCache = [];
    public static bool DrawCommandCacheDirty = false;
    ...
    public static void Init()
    {
        ...
        GL.VertexArrayAttribFormat(VAOHandle, 0, 3, VertexAttribType.Float, false, 0);
        GL.VertexArrayAttribBinding(VAOHandle, 0, 0);

        GL.VertexArrayAttribFormat(VAOHandle, 1, 3, VertexAttribType.Float, false, sizeof(float) * 3);
        GL.VertexArrayAttribBinding(VAOHandle, 1, 0);

        GL.VertexArrayAttribFormat(VAOHandle, 2, 2, VertexAttribType.Float, false, sizeof(float) * 6);
